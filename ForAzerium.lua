...
---
-- Made by IcY Rizz script pack v2
-- Emote menu , to open - Infinite Yield - Slow Mo emotes Hold k to use - system broken - baseplate extended.
...
BackFrame.Size = UDim2.new(0.9, 0, 0.7, 0)
